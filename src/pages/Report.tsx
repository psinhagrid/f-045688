...
const Report = () => {
  ...
  const [summary, setSummary] = useState({ score: 0, issues: 0, improvements: 0 });
  ...
  useEffect(() => {
    ...
    const mockResults: AnalysisResult[] = [
      ...
      },
      {
        ...
        recommendation: "Update authentication flow and implement proper input validation"
      },
      {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/50 p-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-center">Analysis Report</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-4xl font-bold text-center mb-2">{summary.score}/100</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-4xl font-bold text-center">{summary.issues}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-4xl font-bold text-center">{summary.improvements}</div>
            </CardContent>
          </Card>
        </div>
                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <span className={result.score > 70 ? "text-green-600" : result.score > 50 ? "text-amber-600" : "text-red-600"}>
                          {result.score}%
                        </span>
                        <Progress 
                          value={result.score} 
        ...
        <div className="flex justify-center">
          <Button onClick={handleStartOver} variant="outline" className="mr-4">
            Start Over
          </Button>
