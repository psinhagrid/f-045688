  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        <button
          className="hidden md:flex items-center justify-center h-10 px-6 text-sm font-medium text-white bg-primary rounded-full transition-all hover:bg-primary/90 hover:shadow-md active:scale-[0.98]"
        >
          Get Started
        </button>
