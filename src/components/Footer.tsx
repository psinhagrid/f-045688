...
export default function Footer() {
  ...
  return (
    <footer
      className={cn(
        "border-t border-border py-12 md:py-16 bg-background/40",
        "bg-white"
      )}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-foreground/70 max-w-sm mb-6">
              Beautiful design meets perfect functionality. Creating experiences
              that are intuitive, elegant, and beautifully simple.
            </p>
